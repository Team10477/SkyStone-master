...
@Autonomous(name = "Foundation Mission Blue", group = "Mission")
public class FoundationMissionBlue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.setWheelPowerForSide(0.5);    //Robot goes sideways to right under the bridge.
